...
{
    internalToggleVisibilityEx(imgID, divID, false, "", false, false, "%TOC_IMAGE_PLUS%", "%TOC_IMAGE_MINUS%");
}

function toggleVisibilitySection(imgID, divID)
{
    internalToggleVisibilityEx(imgID, divID, false, "", false, false, "%SECTION_IMAGE_PLUS%", "%SECTION_IMAGE_MINUS%");
}
...
function toggleVisibilityStored(storeID)
{
    ...
    internalToggleVisibilityEx(imgID, divID, true, storeID, false, false, "%SECTION_IMAGE_PLUS%", "%SECTION_IMAGE_MINUS%");
}
...
function expandTOC(framedoc, element)
{
    ...
    if ((baseid != "") && (outerdiv != null)) {
        ...
        internalToggleVisibilityEx2(framedoc, "img" + baseid, "div" + baseid, false, "", false, true, "%TOC_IMAGE_PLUS%", "%TOC_IMAGE_MINUS%");
...
function doShowHideCollapsedId(id, visible)
{
    ...
    internalToggleVisibilityEx(imgid, divid, false, "", !visible, visible, "%SECTION_IMAGE_PLUS%", "%SECTION_IMAGE_MINUS%");
}
...
function ToggleAllElements(ids, linkTextID, imgID, collapseAllText, expandAllText)
{
    ...
    if (img != null) {
        if (currentSectionStateExpanded) {
            img.src = "%COLLAPSEALL_IMAGE_MINUS%";
        } else {
            img.src = "%COLLAPSEALL_IMAGE_PLUS%";
        }
    }
}
