...
#define string_GPUOff    2
#define string_GPUOn    3
#define string_GearLabelStringDefault    4
#define string_GearLabelStringSet    5
#define string_MPGUnitString    6
#define string_MPGValueString    7
#define string_MPHLabelString    8
#define string_OdoLabelStringDefault    9
#define string_OdoLabelStringSet    10
#define string_OdoMilesLabelString    11
#define string_SpeedoLabelStringDefault    12
#define string_SpeedoLabelStringSet    13
#define string_TripAStringDefault    14
#define string_TripBStringDefault    15
#define string_TripStringSet    16
