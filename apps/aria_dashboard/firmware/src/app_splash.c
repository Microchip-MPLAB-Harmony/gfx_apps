...
{    
    ...
    switch ( appSplashData.state )
    {
        ...
        case APP_STATE_SPLASH_3:
        {
            ...
            {
                case 20:
                    laImageWidget_SetImage(ImageWidget1, &PIC0MPLAB100);
                    break;
                case 40:
                    laImageWidget_SetImage(ImageWidget1, &PIC25MPLAB75);
                    break;
                case 60:
                    laImageWidget_SetImage(ImageWidget1, &PIC50MPLAB50);
                    break;
                case 80:
                    laImageWidget_SetImage(ImageWidget1, &PIC75MPLAB25);
                    break;
                default:
                    break;
            }
